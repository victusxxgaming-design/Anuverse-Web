const cards = [
  ...
  },
  {
    ...
    desc: 'Veltrion is an officially MSME-registered business, giving you the assurance of dealing with a legitimate, government-recognized Indian company.',
  },
  {
    num: '06',
...
export default function WhyVeltrion() {
  return (
    <section className="why-section" id="why">
      <div className="container">
        <div className="section-header">
          <div className="section-tag"><span className="dot" />Our Promise</div>
          <h2 className="section-title">The Veltrion Difference</h2>
